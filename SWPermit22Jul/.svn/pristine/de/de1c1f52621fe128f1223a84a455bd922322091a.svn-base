...
namespace SidewalkPermitWPF.Model
{
    public class DataService : IDataService
    {
        ...
        public async Task<ObservableCollection<PermitFeeRate>> GetPermitFeeRate()
        {
            ObservableCollection<PermitFeeRate> result = new ObservableCollection<PermitFeeRate>();
            return await HelperClass.GetResponse(result, "GetPermitFeeRate");
        }

        public async Task<PermitFeeRate> UpdatePermitFeeRate(PermitFeeRate permitFeeRate)
        {
            return await HelperClass.PostResponse(permitFeeRate, "UpdatePermitFeeRate");
        }

        public async Task<PermitFee> GetPermitFee()
        {
            PermitFee result = new PermitFee();
            return await HelperClass.GetResponse(result, "GetPermitFee");
        }

        public async Task<PermitFee> UpdatePermitFee(PermitFee permitFee)
        {
            return await HelperClass.PostResponse(permitFee, "UpdatePermitFee");
        }
    }
}