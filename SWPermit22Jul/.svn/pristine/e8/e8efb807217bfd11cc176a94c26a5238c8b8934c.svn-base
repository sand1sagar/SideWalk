...
namespace SidewalkPermitWPF.Model
{
    ...
    public partial class sp_getAffidavitByParameter_swp_Result
    {
        ...
        public Nullable<int> repair_dt { get; set; }
        public Nullable<int> billed_dt { get; set; }
        public Nullable<int> bill_flag { get; set; }
